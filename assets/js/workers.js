...
const DB_VERSION = 2; // Versiyani oshiramiz
  ...
  request.onupgradeneeded = (event) => {
    ...
    store.transaction.oncomplete = function (event) {
      ...
      const sampleWorkers = [
        ...
        {
          name: "Toshmatov Alisher Baxtiyorovich",
          position: "Inspektor",
          militaryRank: "Kapitan",
          qkType: "QK-2",
...
async function viewQRCode(workerId) {
  try {
    ...
    // QR kod ma'lumotlarini tayyorlash
    const qrData = {
      id: worker.id,
      name: worker.name,
      position: worker.position,
      militaryRank: worker.militaryRank,
      qkType: worker.qkType,
    };
                    ...
                    <form id="editWorkerForm">
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="editWorkerName" value="${
                            worker.name
                          }" required>
                        </div>
                        <div class="col-md-6 mb-3">
                          <label for="editWorkerPosition" class="form-label">Lavozim</label>
                          <input type="text" class="form-control" id="editWorkerPosition" value="${
                            worker.position
                          }" required>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="editWorkerMilitaryRank" value="${
                            worker.militaryRank
                          }" required>
                        </div>
                        <div class="col-md-6 mb-3">
                          ...
                          <select class="form-select" id="editWorkerQKType" required>
                            <option value="QK-1" ${
                              worker.qkType === "QK-1" ? "selected" : ""
                            }>QK-1</option>
                            <option value="QK-2" ${
                              worker.qkType === "QK-2" ? "selected" : ""
                            }>QK-2</option>
                            <option value="QK-3" ${
                              worker.qkType === "QK-3" ? "selected" : ""
                            }>QK-3</option>
                          </select>
                        </div>
                      </div>
